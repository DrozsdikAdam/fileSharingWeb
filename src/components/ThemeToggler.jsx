    ...
    <div className="w-full flex flex-row justify-between items-center text-xl">
      <div className="grid grid-cols-2 gap-4 lg:gap-8">
        <button
          ...
          className={`bg-gray-300 hover:scale-105 text-indigo-900 py-1 px-2 rounded-lg border-2 shadow-md shadow-gray-500 hover:bg-gray-400/95 transition-all duration-200 ${
