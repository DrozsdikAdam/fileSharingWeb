    ...
    <div className="w-full flex flex-row justify-between items-center text-xl">
      <div className="grid grid-cols-2 gap-4 lg:gap-8">
        <button
          ...
          className={` hover:scale-105 text-indigo-900 py-1 px-2 rounded-lg border-2 shadow-md bg-gray-300 shadow-gray-500 hover:bg-gray-400/95 transition-all duration-200 ${
            theme === "light" ? "border-indigo-500/80" : "border-indigo-300 "
          }`}
        >
          Világos
        </button>
